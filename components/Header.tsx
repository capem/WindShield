...
const Header: React.FC<HeaderProps> = ({ onToggleSidebar, onUploadClick, unacknowledgedAlarms, isDarkMode, onToggleDarkMode, savedTurbineId, onRestoreTurbineDetail }) => {
        ...
        <header className="bg-white dark:bg-black h-16 flex items-center justify-between px-6 border-b border-slate-200 dark:border-gray-800 flex-shrink-0 transition-theme">
            <div className="flex items-center gap-4">
                ...
                <div className="relative">
                    ...
                    <input type="search" placeholder="Search" className="pl-10 pr-4 py-2 w-64 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500 dark:bg-gray-900 dark:border-gray-700 dark:text-white dark:placeholder-gray-400 transition-theme" />
                </div>
            </div>
                ...
                {savedTurbineId && onRestoreTurbineDetail && (
                    <div className="relative group">
                        ...
                        >
                            ...
                            <span className="hidden sm:inline">Back to Turbine {savedTurbineId}</span>
                        </button>
                 ...
                 <div className="relative group">
                     ...
                     <div className="absolute top-full mt-2 w-max max-w-sm p-3 -translate-x-1/2 left-1/2 bg-gray-900 text-white text-xs rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-10 transition-theme">
                        ...
                        <div className="flex flex-wrap gap-1 mt-1">
                            <code className="bg-gray-800 p-0.5 rounded text-violet-300 text-[11px]">Timestamp</code>
                            <code className="bg-gray-800 p-0.5 rounded text-violet-300 text-[11px]">Turbine ID</code>
                            <code className="bg-gray-800 p-0.5 rounded text-violet-300 text-[11px]">Status</code>
                            <code className="bg-gray-800 p-0.5 rounded text-violet-300 text-[11px]">ActivePower(MW)</code>
                            <code className="bg-gray-800 p-0.5 rounded text-violet-300 text-[11px]">ReactivePower(MVar)</code>
                            <code className="bg-gray-800 p-0.5 rounded text-violet-300 text-[11px]">WindSpeed(m/s)</code>
                            <code className="bg-gray-800 p-0.5 rounded text-violet-300 text-[11px]">Direction(°)</code>
                            <code className="bg-gray-800 p-0.5 rounded text-violet-300 text-[11px]">Temperature(°C)</code>
                            <code className="bg-gray-800 p-0.5 rounded text-violet-300 text-[11px]">RPM</code>
                            <code className="bg-gray-800 p-0.5 rounded text-violet-300 text-[11px]">MaxPower(MW)</code>
                        </div>
                    </div>
                </div>
